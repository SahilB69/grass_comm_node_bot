...
def open_github(event):
    url = "https://github.com/SahilB69/getgrass_bot"
    subprocess.Popen(['start', url], shell=True)


def open_referral(event):
    url = "https://app.getgrass.io/register?referralCode=gO7sC7R1NmSH69J"
    subprocess.Popen(['start', url], shell=True)
...
if __name__ == '__main__':
    ...
    github_label = tk.Label(labels_frame, text="GitHub Repository: https://github.com/SahilB69/getgrass_bot    ",
                            fg="blue")
    github_label.pack(side=tk.LEFT)

    referral_label = tk.Label(labels_frame,
                              text="Referral Link: https://app.getgrass.io/register?referralCode=gO7sC7R1NmSH69J",
                              fg="red")
    ...
    labels_frame.pack()
    log_box.insert(tk.END, 'Please follow the prompts to enter the correct user_id\n', 'info')
    log_box.insert(tk.END, 'The format of Socks5 Proxy is socks5://username:password@ip:port\n', 'info')
